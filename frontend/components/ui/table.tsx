...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn('bg-muted/55 text-muted-foreground [&_tr]:border-b', className)}
      {...props}
    />
  )
}
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-[background-color] duration-[var(--dur-short)] ease-[var(--ease-out)]',
        className,
      )}
      {...props}
    />
