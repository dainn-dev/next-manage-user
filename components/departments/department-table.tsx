...
export function DepartmentTable({ 
  ...
  const getStatusBadge = (status: Employee["status"]) => {
    switch (status) {
      ...
      case "TRANH_THU":
        return <Badge variant="secondary" className="bg-yellow-100 text-yellow-800">Tranh thủ</Badge>
      case "PHEP":
        return <Badge variant="outline" className="bg-blue-100 text-blue-800">Phép</Badge>
      case "LY_DO_KHAC":
