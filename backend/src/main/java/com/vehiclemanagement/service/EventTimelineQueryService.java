...
/**
 * Shared authoritative authorization boundary for dashboard and chatbot history
 * reads.
 */
@Service
public class EventTimelineQueryService {
    ...
    public EventTimelineQueryService(EventTimelineReadRepository repository, SiteAccess siteAccess) {
